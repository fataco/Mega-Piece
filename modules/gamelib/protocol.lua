GameServerOpcodes = {
    ...
    -- 51 - 99
    CdInformations                      = 51, -- vocation, each cd slot spell id
    NavigationInformations              = 52, -- boat percent, boat text, boat id
    GymTicks                            = 53,
    SkillInformations                   = 54,
    AchievementsInfo                    = 55,
    DialGetRuneCharge                   = 56, 
    OutfitList                          = 57,
    TaskModule                          = 58,
    NpcTrade                            = 59,
...
ClientOpcodes = {
    ...
    RequestCdInformations               = 51,
    RequestNavigationInformations       = 52,
    RequestGymInformations              = 53,
    -- Do skill ta reservado, vai que use (54)
    RequestAchievements                 = 55,
    -- Do dial, vai que use ne (atualmente usa talkaction)
    --OutfitList                   = 57, -- usa talkactions pra falar
